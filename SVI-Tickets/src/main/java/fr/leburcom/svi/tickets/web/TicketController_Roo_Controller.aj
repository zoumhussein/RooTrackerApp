...
import fr.leburcom.svi.tickets.web.TicketController;
...
privileged aspect TicketController_Roo_Controller {
    ...
    void TicketController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("ticket_detectiondate_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
        uiModel.addAttribute("ticket_correctiondate_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
    ...
    void TicketController.populateEditForm(Model uiModel, Ticket ticket) {
        ...
        uiModel.addAttribute("ticketstatuses", Arrays.asList(TicketStatus.values()));
    }
